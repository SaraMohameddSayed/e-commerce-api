    ...
    public partial class migrationv1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Category",
                columns: new[] { "id", "name" },
                values: new object[] { 1, "المشروبات" });

            migrationBuilder.InsertData(
                table: "Offer",
                columns: new[] { "id", "discount", "endDate", "name", "startDate" },
                values: new object[] { 1, 10, null, "خصم 10% على المشروبات", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "قهوة عربية تقليدية", "https://example.com/images/arabic-coffee.jpg", "قهوة عربية", 100m, 0 },
                    { 2, 1, "شاي أخضر صحي ومنعش", "https://example.com/images/green-tea.jpg", "شاي أخضر", 200m, 0 }
                });
